...
/**
 * Calculation of density out of the Kirkland file
 * @author yulia
 */
public class DensityChange extends JFrame {
    static double[] temp = null;
    static double mask = 8.1;
    ...
    {      
        Scanner scanner = new Scanner(new File("Al_mono.vacancy-6Proz_cfg_to_Kirkland.xyz"));
        FileWriter fw = new FileWriter("Al_mono.vacancy-6Proz_cfg_to_Kirkland.xyz_profile_81.txt");
        ...
        double[] massive = new double[points];
    ...
    public static class Graph extends JPanel
    {
        ...
        {         
            ...
            for(int i = (int)(mask/sizeY*points); i < temp.length - mask/sizeY*points*2; i++)
            {
                g2.fillRect(i, (int)(temp[i]*5000)-4600, 4, 4);
